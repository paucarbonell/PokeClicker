      ...
      <div className="grid grid-cols-6 gap-3">
        {team.map((poke, i) => (
          <div
            ...
            className={`w-24 h-24 border-2 flex items-center justify-center cursor-pointer ${
              selectedSlot === i ? "border-blue-500" : "border-black"
            }`}
          >
            {poke ? (
        ...
        {Array.isArray(pokemonList) &&
          pokemonList.map((p, i) => (
            <div
              key={i}
              onClick={() =>
                selectedSlot !== null && addToTeam(selectedSlot, p.name)
              }
